...
![20170419215511634](java 中的锁 -- 偏向锁、轻量级锁、自旋锁、重量级锁.assets/20170419215511634.png)
...
![20170418221917277](java 中的锁 -- 偏向锁、轻量级锁、自旋锁、重量级锁.assets/20170418221917277.png)
...
![20170420165422130](java 中的锁 -- 偏向锁、轻量级锁、自旋锁、重量级锁.assets/20170420165422130.png)
...
1. 在代码进入同步块的时候，如果同步对象锁状态为无锁状态（锁标志位为“01”状态，是否为偏向锁为“0”），虚拟机首先将在当前线程的栈帧中建立一个名为锁记录（Lock Record）的空间，用于存储锁对象目前的Mark Word的拷贝，官方称之为 Displaced Mark Word。这时候线程堆栈与对象头的状态如图：
   ...
   ![20170420102716139](java 中的锁 -- 偏向锁、轻量级锁、自旋锁、重量级锁.assets/20170420102716139.jpg)
...
4. 如果这个更新动作成功了，那么这个线程就拥有了该对象的锁，并且对象Mark Word的锁标志位设置为“00”，即表示此对象处于轻量级锁定状态，这时候线程堆栈与对象头的状态如图所示。
   ...
   ![20170420102754608](java 中的锁 -- 偏向锁、轻量级锁、自旋锁、重量级锁.assets/20170420102754608.jpg)
...
![20170420224430096](java 中的锁 -- 偏向锁、轻量级锁、自旋锁、重量级锁.assets/20170420224430096.jpg)
