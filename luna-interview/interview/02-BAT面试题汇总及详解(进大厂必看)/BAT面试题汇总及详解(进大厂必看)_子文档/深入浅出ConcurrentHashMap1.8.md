...
![2184951-728c319f48ebe35a](深入浅出ConcurrentHashMap1.8.assets/2184951-728c319f48ebe35a.png)

### JDK1.8分析

1.8的实现已经抛弃了Segment分段锁机制，利用CAS+Synchronized来保证并发更新的安全，底层采用数组+链表+红黑树的存储结构。

![2184951-3d2365ca5996274f](深入浅出ConcurrentHashMap1.8.assets/2184951-3d2365ca5996274f.png)
